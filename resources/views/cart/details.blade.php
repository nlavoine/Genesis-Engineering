...
@section('content')
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-8">
                <div class="accordion" id="cartDetails">
                    <div class="card">
                        <div class="card-header" id="headingOne">
                            <p class="mb-0  mt-0 font-weight-bold">
                                <button class="btn btn-link" type="button" data-toggle="collapse"
                                        data-target="#personnalInfoTab" aria-expanded="true" aria-controls="personnalInfoTab">
                                    Informations personnelles
                                </button>
                            </p>
                        </div>

                        <div id="personnalInfoTab" class="collapse show" aria-labelledby="personnalInfoTab"
                             data-parent="#cartDetails">
                            <div class="card-body">
                        ...
                        <div class="card-header" id="headingTwo">
                            <p class="mb-0  mt-0 font-weight-bold">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                        data-target="#addressTab" aria-expanded="false"
                                        aria-controls="addressTab">
                                    Adresses
                                </button>
                            </p>
                        </div>
                        <div id="addressTab" class="collapse" aria-labelledby="addressTab"
                             data-parent="#cartDetails">
                            <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header font-weight-bold" id="headingThree">
                            <p class="mb-0  mt-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                        data-target="#shippingTab" aria-expanded="false"
                                        aria-controls="shippingTab">
                                    Mode de livraison
                                </button>
                            </p>
                        </div>
                        <div id="shippingTab" class="collapse" aria-labelledby="shippingTab"
                             data-parent="#cartDetails">
                            <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header font-weight-bold" id="headingFour">
                            <p class="mb-0  mt-0">
                                <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                        data-target="#paimentTab" aria-expanded="false"
                                        aria-controls="paimentTab">
                                    Paiement
                                </button>
                            </p>
                        </div>
                        <div id="paimentTab" class="collapse" aria-labelledby="headingFour"
                             data-parent="#cartDetails">
                            <div class="card-body">
                                Anim pariatur cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad
                                squid. 3 wolf moon officia aute, non cupidatat skateboard dolor brunch. Food truck
