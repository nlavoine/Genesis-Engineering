            ...
            <div class="container-fluid sectionGamme mb-8 mt-5">
                <div class="row no-gutters sectionContent">
                    ...
                    <div class="col-sm-6 col-md-4 ml-6 mb-5 text-justify">
                        ...
                        <h2><input name="name" value="{{$product->name}}"/></h2>
                        <div class="product-price">
                            <input type="number" value="{{ $product->price }}" class="price" name="price" step=".01"/>€
                        </div>
                        <p class="text-left"><input type="number" value="{{ $product->stock }}" class="stock w-auto d-inline" name="stock" step="1"/></p>
                        <hr class="mt-5" />
                        <!--
                       DETAILS 1
                       -->
                        <h5 class="mt-5">Description 1</h5>
                        <textarea name="details_1" class="regular-text text-gray8 details">
                            {!! $product->details_1 !!}
                        </textarea>
                        ...
                        <textarea name="details_2" class="regular-text text-gray8 details">
                            {!! $product->details_1 !!}
                        </textarea>
                        ...
                        <a href="{{route('admin.product.show', $product->id)}}" class="btn btn-secondary btn-lg rounded-0 mt-3">Annuler</a>
                    </div>
                </div>
            </div>
        </form>
